    ...
    return (
        <>
            <div className="stepperOneContainer">
                <img src={require("../../assets/order_status_order_accepted_illustration_stage4@3x.png")} alt="img" className='stepperTopImg' />
                <div className="stepperstages">
                    ...
                    <div className="stage3 stage1">
                        ...
                        <span className='bottomText2'>Track Order</span>
                    </div>
